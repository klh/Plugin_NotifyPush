...
PushNotification.prototype.getToken = function(successCallback, errorCallback) {
        if (errorCallback == null) { errorCallback = function() {}}
        
        if (typeof errorCallback != "function")  {
            console.log("PushNotification.getToken failure: failure parameter not a function");
            return;
        }
        
        if (typeof successCallback != "function") {
            console.log("PushNotification.gettoken failure: success callback parameter must be a function");
            return;
        }
